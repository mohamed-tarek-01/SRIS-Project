...
<?php $__env->startSection('title', 'Car Damage'); ?>
    ...
    <div class="space-y-8 max-w-4xl mx-auto">
        <div class="text-center space-y-4">
            ...
            <p class="text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
                Assess structural and exterior damage to vehicles following collisions, grading severity for insurance claims processing.
            </p>
        </div>

        <div class="relative z-10 w-full animate-fade-in-up" style="animation-delay: 100ms;">
            <?php
                $endpoint = url('/api/ml/car_damage/detect');
            ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/car_damage.blade.php ENDPATH**/ ?>